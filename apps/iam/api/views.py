...
class CookieTokenRefreshView(jwt_views.TokenRefreshView):
    ...
    serializer_class = iam_serializers.CookieTokenRefreshSerializer
...
class LogoutView(TokenViewBase):
    ...
    permission_classes = ()
    serializer_class = iam_serializers.LogoutSerializer
...
class UserSignupView(generics.CreateAPIView):
    ...
    serializer_class = iam_serializers.UserSignupSerializer
    permission_classes = [AllowAny]


class UserAccountConfirmView(generics.GenericAPIView):
    """Confirm user email address"""
    serializer_class = iam_serializers.UserAccountConfirmationSerializer
    permission_classes = [AllowAny]
...
class PasswordResetView(generics.GenericAPIView):
    ...
    serializer_class = iam_serializers.PasswordResetSerializer
    permission_classes = [AllowAny]
...
class PasswordResetConfirmView(generics.GenericAPIView):
    ...
    serializer_class = iam_serializers.PasswordResetConfirmationSerializer
    permission_classes = [AllowAny]
...
class PasswordChangeView(generics.GenericAPIView):
    ...
    serializer_class = iam_serializers.UserAccountChangePasswordSerializer
...
class UserProfileViewSet(viewsets.ModelViewSet):
    ...
    serializer_class = iam_serializers.UserProfileSerializer
    permission_classes = [IsAuthenticated]
...
class OTPGenerateView(generics.GenericAPIView):
    ...
    def post(self, request):
        from iam.services import otp as otp_services
...
class OTPVerifyView(generics.GenericAPIView):
    """Verify OTP code"""
    serializer_class = iam_serializers.VerifyOTPSerializer
    permission_classes = [IsAuthenticated]
...
class OTPDisableView(generics.GenericAPIView):
    ...
    serializer_class = iam_serializers.DisableOTPSerializer
    permission_classes = [IsAuthenticated]
