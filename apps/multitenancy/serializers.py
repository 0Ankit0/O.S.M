...
class TenantSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        create_tenant_membership(
            user=validated_data["created_by"], tenant=tenant, role=TenantUserRole.OWNER, is_accepted=True
        )
        return tenant
...
class AcceptTenantInvitationSerializer(TenantInvitationActionSerializer):
    ...
    def create(self, validated_data):
        ...
        if membership:
            ...
            notifications.send_accepted_tenant_invitation_notification(membership, str(membership_id))
        return {"ok": True}
...
class DeclineTenantInvitationSerializer(TenantInvitationActionSerializer):
    ...
    def create(self, validated_data):
        ...
        if membership:
            membership.delete()
            notifications.send_declined_tenant_invitation_notification(membership, str(membership_id))
        return {"ok": True}
...
class CreateTenantInvitationSerializer(serializers.Serializer):
    ...
    role = serializers.ChoiceField(choices=TenantUserRole.choices)
...
class TenantInvitationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ("id", "is_accepted", "created_by", "created_at")
