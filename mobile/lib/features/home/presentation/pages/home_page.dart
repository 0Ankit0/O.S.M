      ...
      body: ListView(
        ...
        children: [
          ...
          _QuickAccessCard(
            ...
            title: 'Shop Menu',
            subtitle: 'Browse sushi, starters, desserts, and more',
            color: Colors.deepOrange,
            onTap: () => context.go('/home/shop'),
          ),
          const SizedBox(height: 8),
          _QuickAccessCard(
            icon: Icons.shopping_cart_checkout,
            title: 'Cart',
            subtitle: 'Review items, apply a coupon, and place an order',
            color: Colors.green,
          ...
          _QuickAccessCard(
            ...
            title: 'Orders',
            subtitle: 'Track active and past restaurant orders',
            color: Colors.blue,
